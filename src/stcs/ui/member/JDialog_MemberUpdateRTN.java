 ...
 */
public class JDialog_MemberUpdateRTN extends javax.swing.JDialog {

    /**
     * Creates new form JDialog_MemberUpdateRTN
     */
    public JDialog_MemberUpdateRTN(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialog_MemberUpdateRTN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialog_MemberUpdateRTN dialog = new JDialog_MemberUpdateRTN(new javax.swing.JFrame(), true);
