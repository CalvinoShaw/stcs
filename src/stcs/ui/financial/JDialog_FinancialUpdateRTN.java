 ...
 */
public class JDialog_FinancialUpdateRTN extends javax.swing.JDialog {

    /**
     * Creates new form JDialog_MemberUpdateRTN
     */
    public JDialog_FinancialUpdateRTN(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialog_FinancialUpdateRTN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialog_FinancialUpdateRTN dialog = new JDialog_FinancialUpdateRTN(new javax.swing.JFrame(), true);
