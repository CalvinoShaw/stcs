 ...
 */
public class JFrame_PasswordUpdateUI extends javax.swing.JFrame {

    public static int admin_id;
    
    /**
     * Creates new form JFrame_PasswordUpdateUI
     */
    public JFrame_PasswordUpdateUI(int admin_id) {
        initComponents();
    ...
    private void Button_sureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Button_sureActionPerformed
        ...
        if("".equals(oldpass.getText())){
            ...
            bo.admin_passUpdate(admin_id, oldpassword, newpassword);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrame_PasswordUpdateUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrame_PasswordUpdateUI(admin_id).setVisible(true);
            }
        });
    }
